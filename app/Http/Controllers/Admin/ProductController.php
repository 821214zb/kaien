...
class ProductController extends Controller
{
  ...
  public function toProductInfo(Request $request) {
    ...
    $pdt_content = ProductContent::where('product_id', $id)->first();
    $pdt_images  = ProductImage::where('product_id', $id)->get();
  ...
  public function productAdd(Request $request)
  {
    ...
    //保存产品的详细介绍信息
    $pdt_content = new ProductContent;
